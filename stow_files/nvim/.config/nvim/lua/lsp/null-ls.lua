...
local function register_failed_request(ft, provider, operation)
  if not nvim.lang[ft][operation]._failed_requests then
    nvim.lang[ft][operation]._failed_requests = {}
  end
  table.insert(nvim.lang[ft][operation]._failed_requests, provider)
end
